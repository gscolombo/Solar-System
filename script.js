  ...
  function set() {
    ...
    if (canvas.getContext) {
      ...
      class Planet {
        ...
        configTranslation = () => {
          return (
            (this.midpointX = centerX - this.sizeX / 2),
        ...
        setTranslation = (angle, fx = 0, fy = 0) => {
          ...
          this.yPos =
            this.midpointY + this.y * Math.cos(angle) + fy * Math.cos(angle);
      ...
      class Moon extends Planet {
        ...
        setRefCenter = () => {
          return (
            (this.refX = this.refPlanet.xPos + this.refPlanet.sizeX / 2),
        ...
        configTranslation = () => {
          return (
            (this.midpointX = this.refX - this.sizeX / 2),
      ...
      function draw() {
        ...
        // Júpiter
        jupiter.setTranslation(angle * 0.4, 20);
        jupiter.insert();

        // Saturno
        saturn.setTranslation(angle * 0.375, 5);
        ...
        // Urano
        uranus.setTranslation(angle * 0.3, 7.5, 3.25);
        ...
        // Netuno
        neptune.setTranslation(angle * 0.275, 3, 2.5);
        neptune.insert();
        ...
        // Fobos e Deimos
        deimos.insertMoon(-0.93, angle * 0.25);
        fobos.insertMoon(1.09, angle * 0.5);

        // Ganimedes, Calisto, Io e Europa
        ganymede.insertMoon(-22, angle * 0.15);
        io.insertMoon(0.5, angle * 0.8);
        europa.insertMoon(4.7, angle * 0.7);
        calisto.insertMoon(10, angle * 0.4);

        // Titã
        titan.insertMoon(-15, angle * -0.75, 5);
